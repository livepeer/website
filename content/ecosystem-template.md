...
- **Capability one** — short description of what users can do
- **Capability two** — short description of what users can do
- **Capability three** — short description of what users can do

## Developer surface

- **How it runs** — self-hosted, cloud, hybrid, SDK, etc.
- **What ships with it** — models, APIs, integrations, bundled tooling
- **How to extend it** — plugin model, open source, custom pipelines
