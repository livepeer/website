...
For the past year, the Livepeer Ecosystem has been guided by the [Cascade vision](https://blog.livepeer.org/introducing-livepeer-cascade-a-vision-for-livepeers-future-in-the-age-of-real-time-ai-video/): a path to transition from a pure streaming and transcoding infrastructure, to an infrastructure that could succeed at providing compute for the future of real-time AI video. The latest Livepeer [quarterly report from Messari](https://messari.io/report/state-of-livepeer-q3-2025) highlights that this transition is paying off, with network fees up 3x from this time last year, and over 72% of the fees now driven via AI inference. This is exemplified by the growing inspirational examples emerging from [Daydream powered real-time AI](http://daydream.live/), and real-time Agent avatar generation through Embody and the Agent SPE.

![](/images/blog/a-real-time-update-to-the-livepeer-network-vision/messari-q3-2025.png)

_Source: Livepeer Q3 2025 Report by Messari_
...
>
> (sound on) [pic.twitter.com/66aOdWJr4Y](https://t.co/66aOdWJr4Y)
>
> — Matt Shumer (@mattshumer\_) [October 23, 2025](https://twitter.com/mattshumer_/status/1981406315693187430)

2. Video streams can be analyzed and data leveraged programmatically in real-time, for instant insight generation and decision making:
...
>
> ↓ coolest stuff I made [pic.twitter.com/EMy5qWq1Vp](https://t.co/EMy5qWq1Vp)
>
> — SkalskiP (@skalskip92) [October 29, 2025](https://twitter.com/skalskip92/status/1983585881865982149)

3. Real-time style transfer can enable avatars and agents to participate in the global economy:

> 🇨🇳 We're screwed … it becomes indistinguishable from reality
>
> Ali's Wan 2.2 lets you stream without showing your face. It maps your voice and motion onto another face. [pic.twitter.com/iD4nQIVaRY](https://t.co/iD4nQIVaRY)
>
> — Lord Bebo (@MyLordBebo) [October 30, 2025](https://twitter.com/MyLordBebo/status/1983846299586683236)
...
![](/images/blog/a-real-time-update-to-the-livepeer-network-vision/real-time-ai-opportunities-by-industry.png)

While an ambitious stretch, Nvidia executives responsible for the category have even projected that due to the impact in robotics, [the economic opportunity for world models could exceed $100 trillion](https://arstechnica.com/ai/2025/09/big-ai-firms-pump-money-into-world-models-as-llm-advances-slow/#:~:text=Both%20Niantic%20and%20Nvidia%20are,work%2C%E2%80%9D%20said%20Nvidia's%20Lebaredian.), or approximately the size of the entire global economic output itself!
