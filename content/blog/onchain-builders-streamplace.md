...
<!-- Image: Streamplace homepage screenshot — original was a Google Docs embed that is no longer accessible and was not archived by the Wayback Machine. Replace with a current screenshot of stream.place if desired. -->
...
<!-- Image: Streamplace Grafana dashboard — original was a Google Docs embed that is no longer accessible and was not archived by the Wayback Machine. Replace with a current dashboard screenshot if desired. -->
...
Do you want to contribute to Streamplace's success? Explore the open roles [here](https://jobs.stream.place/).

Interested in building or contributing to the Livepeer ecosystem? Learn more about current and past SPEs, open opportunities, and how to submit your own proposal [here](https://livepeer.notion.site/Livepeer-Governance-Hub-13d0a348568780a598acc869d19f14c8).

Follow along, fork the code, or join a stream — the future of social video is open.

### Links

[Streamplace App](https://app.stream.place/)

[Streamplace Proposal](https://explorer.livepeer.org/treasury/69979842640287825025581148561220268429620025129899844442017200219379700175479)

[Aquareum Proposal](https://explorer.livepeer.org/treasury/74518185892381909671177921640414850443801430499809418110611019961553289709442)

---

Livepeer is a decentralized video infrastructure network for live and on-demand streaming. It has integrated AI Video Compute capabilities (Livepeer AI) by harnessing its massive GPU network and is now building the future of real-time AI video.
